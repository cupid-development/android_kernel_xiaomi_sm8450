...
#define VDO_S(svid, ver, cmd_type, cmd, obj)                                   \
	VDO(svid, 1,                                                           \
	    VDO_SVDM_VERS(ver) | VDO_CMDT(cmd_type) | VDO_OPOS(obj) | cmd)
...
{
	return pd_send_svdm_request(pd_port, sop_type, svid, CMD_DISCOVER_MODES,
...
static inline int pd_send_vdm_enter_mode(struct pd_port *pd_port,
					 ...
					 uint8_t obj_pos)
{
	return pd_send_svdm_request(pd_port, sop_type, svid, CMD_ENTER_MODE,
				    obj_pos, 0, NULL, PD_TIMER_VDM_MODE_ENTRY);
}
...
static inline int pd_send_vdm_exit_mode(struct pd_port *pd_port,
					...
					uint8_t obj_pos)
{
	return pd_send_svdm_request(pd_port, sop_type, svid, CMD_EXIT_MODE,
				    obj_pos, 0, NULL, PD_TIMER_VDM_MODE_EXIT);
}
...
static inline int pd_send_vdm_attention(struct pd_port *pd_port,
					...
					uint8_t obj_pos)
{
	return pd_send_svdm_request(pd_port, sop_type, svid, CMD_ATTENTION,
				    obj_pos, 0, NULL, 0);
}
