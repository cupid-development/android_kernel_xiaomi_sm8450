...
extern bool is_client_vote_enabled(struct votable *votable,
...
extern int get_client_vote_locked(struct votable *votable,
				  const char *client_str);
...
extern int vote(struct votable *votable, const char *client_str, bool state,
		int val);
...
extern struct votable *create_votable(
